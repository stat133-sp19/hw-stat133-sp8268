...
**Yoda Trivia**
* Yoda is 2 feet tall 
  + This is typical of most hobbits
* Yoda used to be a Death Eater but he curbed his evil and joined the Allies
* He has a green wand
...
Here is a recipe for brown butter cookies. It is recommended you consume them in fall seasons.
![They look like this](cookie.png)
...
4. Chill for an hour
5. Slice the log into $(1/2)^2$  inch logs
...
$= \sqrt{\sum_{n=1}^{n} (q_i - p_i)^2}$

The position of a point in a Euclidean *n*-space is a Euclidean vector. So, **p** and **q** may be represented as Euclidean vectors, starting from the origin of the space (initial point) with their tips (terminal points) ending at the two points. The Euclidean norm, or **Euclidean length**, or **magnitude** of a vector measures the length of the vector:

$\| \mathbf{p} \| = \sqrt{(p_1^2) + (p_1^2) + {\cdots} + (p_1^2)} = \sqrt{\textbf{p}{\cdot}\textbf{p}}$
...
$\mathbf{q-p} = (q_1-p_1, q_2-p_2, {\cdots}, q_n-p_n)$.
